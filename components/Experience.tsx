            ...
            <div className="w-full flex flex-wrap items-center gap-2 lg:gap-6 justify-between">
                <div className="flex items-center gap-2 lg:gap-4 pr-7 rounded-full bg-black">
                    <div className="bg-[#ffffff] rounded-full overflow-hidden p-3 md:p-4 border border-black">
                        ...
                        <Image src="/images/memoji.svg" alt="Calendar" width={34} height={34} className="w-5 sm:w-6 md:w-8 lg:w-auto" />
                    </div>
                    <div className="flex flex-col items-start lg:gap-1">
                        <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-mainColor">{data?.company}</h1>
                ...
                <div className="uppercase flex items-center bg-[#ffffff] group-hover:bg-[#fff1cc] text-sm sm:text-base md:text-base lg:text-xl gap-2 md:gap-3 text-black font-semibold px-4 py-3 rounded-full">
                    <Image src="/images/calender-b.svg" alt="calender" width={34} height={34} className="w-5 sm:w-6 md:w-8 lg:w-auto" />
                    <p>{data.year}</p>
                </div>
            </div>
            <div className="flex items-center gap-2 md:gap-4">
                <Image src="/images/memoji.svg" alt="Memoji" width={60} height={60} className="rounded-full w-11 sm:w-12 md:w-13 lg:w-auto aspect-square" />
...
const Experience = () => (
    <div id="experience" className="main-container w-full py-[40px] md:py-[60px] lg:py-[80px] flex flex-col items-center">
        <div className="relative w-full text-center">
            <h2 className="opacity-10 text-4xl md:text-6xl lg:text-7xl font-bold text-outline">Experience</h2>
            <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-mainColor">Experience</h3>
        </div>
